...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <img src="assets\img\Logo_mundo_movil.png">
 ...
 <a class="navbar-brand" href="admin">Login Administrador</a>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p class="lead fw-normal text-white-50 mb-0">La tecnologia A tan solo un Click</p>
            </div>
        </div>
    </header>
    <section class="py-5">
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; movilsoft.srl 2023 UAPA</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
